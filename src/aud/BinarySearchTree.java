...
public class BinarySearchTree<Key extends Comparable<Key>, Value>
    ...
    protected Node rotateLeft(Node node) {
        Node a = node;
        Node b = (Node) node.getRight();
        assert (b != null);
        Node c = (Node) b.getRight();
        assert (c != null);
    ...
    protected Node rotateRightLeft(Node node) {
        Node a = node;
        Node c = (Node) node.getRight();
        assert (c != null);
        Node b = (Node) c.getLeft();
        assert (b != null);
    ...
    protected Node rotateRight(Node node) {
        Node c = node;
        Node b = (Node) node.getLeft();
        assert (b != null);
        Node a = (Node) b.getLeft();
        assert (a != null);
