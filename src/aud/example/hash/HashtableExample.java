...
public class HashtableExample {
    ...
    public class DoubleHashing<T> extends CollisionHandler<T> {
        ...
        public DoubleHashing(HashFunction<T> h2) {
            h2_ = h2;
        }
    ...
    class HashKey extends HashFunction<Key> {
        ...
        HashKey(HashFunction<Integer> hash) {
            this.ihash = hash;
        }

        @Override
        public long hash(Key k) {
            return ihash.hash((int) k.intValue);
        }
