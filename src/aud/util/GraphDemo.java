...
public class GraphDemo extends SingleStepper {
    ...
    public static void main(String[] args) {
        ...
        SimpleEdge e0 = g.addEdge(n0, n1);
        app.whereAmI().showSource().halt("add e0");
        SimpleEdge e1 = g.addEdge(n1, n0);
        app.halt("add e1");

        SimpleEdge e2 = g.addEdge(n0, n2);
        app.halt("add e2");
        SimpleEdge e3 = g.addEdge(n2, n1);
        app.halt("add e3");
        ...
        decorator.markNode(n0);
        app.halt();
        n0.setLabel("A");
        e0.setLabel("a b c");
        decorator.markEdge(e0);
        app.halt();
        decorator.unmarkNode(n0);
        decorator.markNode(n1);
        app.halt();
        decorator.highlightNode(n2);
        decorator.highlightEdge(e2);
        app.halt();
