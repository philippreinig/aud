...
public class GraphvizDecorator {
  ...
  public String getAllNodesDecoration() { return "shape=circle"; }
  /** get standard decoration for all edges (list head) */
  public String getAllEdgesDecoration() { return null; }
  /** get global style (returns same for all nodes/edges) */
  public String getGlobalStyle() { return null; }

  /** concatenates {@link #getAllNodesDecoration} and {@link #getNodeDecoration} */
  ...
  /** concatenates {@link #getAllEdgesDecoration} and {@link #getEdgeDecoration} */
