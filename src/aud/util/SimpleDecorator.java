...
public class SimpleDecorator extends CommonGraphvizDecorator {
    ...
    @Override
    public void highlightNode(GraphvizDecorable object) {
        hilit_node = object;
    }

    @Override
    public void highlightEdge(GraphvizDecorable object) {
        hilit_edge = object;
    }

    @Override
    public void markNode(GraphvizDecorable object) {
        marked_nodes.add(object);
    }

    @Override
    public void unmarkNode(GraphvizDecorable object) {
    ...
    @Override
    public void markEdge(GraphvizDecorable object) {
        marked_edges.add(object);
    }

    @Override
    public void unmarkEdge(GraphvizDecorable object) {
