...
public class SparseMatrixCS<T> {
    ...
    public int getNumColumns() {
        return mat_.size() == 0 ? 0 : mat_.lastKey().j;
    }
    ...
    public int getMinColumnIndex() {
        return mat_.size() == 0 ? 0 : mat_.firstKey().j;
    }
     ...
     */
    public T set(int i, int j, T data) {
     ...
     * @throws IndexOutOfBoundsException on error (non-positive index)
     */
    public int columnDegree(int j) {
        return getColumnEntries(j).size();
    }
